        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="field border rounded-md p-3 mb-3 flex flex-col lg:flex-row justify-between items-center sm:items-start gap-5 lg:gap-10">
                ...
                <div className="flex gap-4">
                    <label
                        className={`flex w-24 p-3 rounded-md shadow-md cursor-pointer border-2 items-center justify-between ${touchedFields.purchasing_yourself && errors.purchasing_yourself
                            ? "border-red-500"
                    ...
                    >
                        ...
                        <div className="flex items-center">
                            <span
                                className={`text-sm font-semibold uppercase ${purchasingYourself === "yes" ? "text-[#4DB581]" : "text-gray-500"
                                    }`}
                            >
                                Yes
                            </span>
                    ...
                    >
                        ...
                        <div className="flex items-center">
                            <span
                                className={`text-sm font-semibold uppercase ${purchasingYourself === "no" ? "text-red-700" : "text-gray-500"
                                    }`}
                            >
                                No
                            </span>
            ...
            <div className="field border rounded-md p-3 mb-3 flex flex-col lg:flex-row justify-between items-center sm:items-start gap-5 lg:gap-10">
                ...
                <div className="flex gap-4">
                    <label
                        className={`flex w-24 p-3 rounded-md shadow-md cursor-pointer border-2 items-center justify-between ${touchedFields.ability && errors.ability
                            ? "border-red-500"
                            : ability === "yes"
                                ? "border-[#4DB581] bg-green-50"
                                : "border-gray-300 bg-white"
                    ...
                    >
                        <div className="flex items-center">
                            <span
                                className={`text-sm font-semibold uppercase ${ability === "yes" ? "text-[#4DB581]" : "text-gray-500"
                                    }`}
                            >
                                Yes
                            </span>
                    ...
                    >
                        ...
                        <div className="flex items-center">
                            <span
                                className={`text-sm font-semibold uppercase ${ability === "no" ? "text-red-700" : "text-gray-500"
                                    }`}
                            >
                                No
                            </span>
            ...
            >
                <div>
                    ...
                    <div
                        className={`my-4 space-y-2 ${ability !== "yes"
                            ? "disabled:opacity-50 disabled:bg-gray-400 disabled:cursor-not-allowed pointer-events-none"
                            : ""
                            }`}
                    ></div>
                    ...
                    <div>
                        <ul
                            className={`list-disc list-inside text-sm space-y-1 pl-6 text-left ${ability !== "yes" || purchasingYourself !== "yes"
