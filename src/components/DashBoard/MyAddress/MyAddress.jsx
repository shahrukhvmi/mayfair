...
const MyAddress = () => {
  ...
  useEffect(() => {
    if (isDataLoaded && billing) {
      ...
      triggerBilling(["billingCountry", "billingStreetAddress", "billingStreetAddress2", "billingCity", "billingState", "billingCountry", "billingPostalCode"]);
    }
  ...
  }, [activeTab, watchShipping, watchBilling]);
