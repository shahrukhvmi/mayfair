...
const StepSeven = ({ setHideSidebar }) => {
  ...
  const handleVariationClick = (name, index) => {
    ...
    if (!stepProps.isReturning && !openedVariationIndex.includes(index) && !lowestMgValues.includes(clickedMgValue)) {
  ...
  return (
    ...
    <section className="flex items-center justify-center pb-20 sm:pb-0">
