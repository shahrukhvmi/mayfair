            ...
            <div className="jumbotron text-center thank-you-main">
                <div className="container d-flex justify-content-center">
                    <div className="process-payment bg-white p-4 rounded">
                        ...
                        <div className="row justify-content-center">
                            <div className="col-6">
                                <p className="stay-text lead">
                                    Do not leave this page, you will be
                                    redirected to payment promptly.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                >
                    ...
                    <fieldset>
                        ...
                        <p>
                            <label htmlFor="responseSuccessURL">
                                Success URL:
                            </label>
                            <input
                                type="hidden"
