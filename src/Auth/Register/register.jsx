        ...
        <form onSubmit={handleSubmit(onSubmit)} style={{ width: "100%" }}>
          ...
          <div className="mb-4 w-full">
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-md bg-[#f4f6ff] text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 ${errors.confirmEmail ? "border-red-500" : "border-gray-300"
                }`}
            />
            {errors.confirmEmail && (
              <p className="mt-1 text-sm text-red-500">{errors.confirmEmail.message}</p>
            )}
          </div>
          ...
          <div className="mb-4 w-full relative">
            ...
            {/* Toggle Eye Icon */}
            <div
              className="absolute right-3 top-[34px] cursor-pointer text-purple-600"
          ...
          <div className="mb-4 w-full relative">
            ...
            <input
              ...
              className={`w-full px-4 py-2 pr-10 border rounded-md bg-[#f4f6ff] text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 ${errors.confirmPassword ? "border-red-500" : "border-gray-300"
                }`}
            />
